...
- **Added:** 2026-03-20 (seed) | **Last deep:** 2026-03-26T04:01 | **Pattern hits:** 9 | **SHA:** aa7daf0
- **Notes:** Most productive source so far. 9 pattern hits across v0.9.7-v0.11.18.2. v0.11.12.1: "one decision per question" AskUserQuestion rule (interactive-session, not applicable). v0.11.13.0: test coverage gate + plan completion audit (already adopted #98). v0.11.16.0: 2-tier E2E test system gate/periodic split with touchfiles (CI-specific, no E2E tests). v0.11.18.2: Windows browse fix. Pattern yield declining — all recent patterns either already adopted or interactive/CI-specific. SHA changed (9870a4e→aa7daf0) — deep-dive next PH.
...
- **Added:** 2026-03-20 (seed) | **Last deep:** 2026-03-25T07:41 | **Pattern hits:** 0 | **SHA:** 2e0f345
- **Notes:** SHA 077d9a8→2e0f345. Likely ticker (13th+ consecutive content-free change). 0 pattern hits across 13+ observations. Low-value for PATTERN_HUNT; retain for HORIZON_SCAN cross-reference only.

### bytedance/deer-flow
- **Why:** Multi-agent orchestration patterns from a major tech company
- **Look for:** Agent coordination, state management, tool orchestration, LLM provider patterns
- **Added:** 2026-03-21 (seed) | **Last deep:** 2026-03-25T17:12 | **Pattern hits:** 1 | **SHA:** d119214
- **Notes:** Very active (5+ commits/day). GuardrailMiddleware covered by #67. All Python/LangGraph-specific historically. 0 harness patterns across 7+ consecutive deep-dives — reduced deep-dive priority. SHA changed (792c49e→d119214) — note for next PH.
...
- **Added:** 2026-03-20 (seed) | **Last deep:** 2026-03-25T17:12 | **Pattern hits:** 0 | **SHA:** 87fd6a4
...
- **Notes:** v10.6.2 active (Mar 21). SHA e2a2302 unchanged (2nd consecutive). Their compress-filter-inject pipeline is more sophisticated than our simple state/ read/write. Could improve how we manage project_state.md context.
...
- **Added:** 2026-03-23 (horizon scan) | **Observations:** 25 | **First seen:** 2026-03-23
- **Notes:** v0.1.36+, very active. SHA 76c818f→9a0fb95 (changed): macOS app menu branding, markdown preview toggle in diff view. UI-focused. 1 pattern hit (SHA pinning). No new harness patterns.
...
- **Added:** 2026-03-23 (horizon scan) | **Observations:** 25 | **First seen:** 2026-03-23
- **Notes:** SHA 9df4731 unchanged (2nd consecutive). 34+ plugins with formal SKILL.md standard. skill-improver quality loop. Codex compatibility layer. PR #123: cross-platform sidecar symlink distribution. Pattern hit: SKILL.md quality standard (issue #68).
...
- **Notes:** SHA 0afb519→b868448 (changed): star history chart update, apply-optimize isolation. Routine. NPX installer, bundles by role. Confirms direction of #66.
...
- **Added:** 2026-03-23 (horizon scan) | **Observations:** 23 | **First seen:** 2026-03-23
- **Notes:** v2.29.0. SHA bb3a21a unchanged (2nd consecutive). Validates markdown-as-memory, SKILL.md format with i18n. Active community (115+ PRs).
...
- **Notes:** SHA c07ff8f unchanged. Deep-dived 2026-03-26. ruflo-specific architecture, not directly adoptable. 0 harness patterns.
...
- **Notes:** SHA 8d96785 unchanged (2nd consecutive). 1 pattern hit (circuit breaker #76). Informational for #66.
...
- **Notes:** SHA b10b583 unchanged (2nd consecutive). Standard plugin format: .claude-plugin/plugin.json + commands/ + agents/ + skills/. Distribution channel for #66. 1 pattern hit (official plugin format).
...
- **Notes:** SHA 49840c2 unchanged. 1 pattern hit (multi-agent review quality gate). Self-learning pattern similar to our feedback-learner. evaluate-session.sh for session outcomes.
...
- **Added:** 2026-03-24 (horizon scan) | **Observations:** 21 | **First seen:** 2026-03-24
- **Notes:** SHA 55adfcb unchanged (2nd consecutive). Rust. v0.16.5 (Mar 23). Active development (675+ PRs). Could validate CLAUDE.md/SKILL.md in CI. 0 pattern hits.
...
- **Added:** 2026-03-24 (horizon scan) | **Observations:** 22 | **First seen:** 2026-03-24
- **Notes:** SHA 51494de unchanged (2nd consecutive). Python. v2.3.1. Validates #66 packaging (skills/ dir with symlinks). Architecturally most similar to tokenman. 0 direct pattern hits.
