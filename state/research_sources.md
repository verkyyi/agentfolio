...
- **Notes:** Protected source — never drop. Check CHANGELOG and releases, not just commits. v2.1.81: --bare flag (issue #63). SHA 6aadfbd unchanged 10th consecutive.
...
- **Notes:** v0.1.36+, very active (SHA d9a2c4f, was e96323b — continued active dev). feat: link PRs to issues directly — interesting automation pattern. Rust+TS monorepo.
...
- **Notes:** v2.28.0. SHA bb3a21a (was 3b6c3ce — changed). Uses SKILL.md format with i18n variants (zh-TW). Validates our state/ markdown approach for persistent planning. Active community (113+ PRs).
...
- **Added:** 2026-03-24 (horizon scan) | **Observations:** 10 | **First seen:** 2026-03-24
