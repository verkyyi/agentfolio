...
- **Resume theme:** `ResumeTheme.tsx` renders any valid JSON Resume document using styled-components. Based on jsonresume-theme-onepage. Supports all 12 JSON Resume sections.
