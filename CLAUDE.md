...
└── .github/workflows/       # GitHub Actions
    ...
    ├── adapt.yml            # Generate adaptations on data/ changes
...
- **Resume source of truth:** `data/resume.md` — any text format. `data/adapted/` and `data/slugs.json` are auto-generated and should not be edited manually.
